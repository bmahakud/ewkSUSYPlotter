template <class classInst, class HistogramCreater> class Looper_sig: public HelperClass{
public:
...
template <class classInst,class HistogramCreater> void Looper_sig<classInst,HistogramCreater>::Loop(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, HistogramCreater hs,string ProcessName, double lumi)
...
const int processesSize=26;
       ...
       trF2->GetEntry(iEv);
          ...
          if(iEv % 5000==0)std::cout<<"Running on "<<ProcessName<<" event no: "<<iEv<<"---completed : "<<(float(iEv)/float(trN->GetEntries()))*100<<" %"<<std::endl;
            ...
            EventWeight=xsecWeights[processInt]*lumi*0.101;
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::Baseline(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::ProcessCuts(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){
...
template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::Basic(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){

if(readN.met_pt > 50){return true;} else{return false;}
}

template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::BasicPlus(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){

if(readN.met_pt > 50 && readF2.mllL_3l >12.){return true;} else{return false;}
}

template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_2016Bins(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){
double mTW=readF2.mTL_3l;double MET=readN.met_pt;double Mll=readF2.mllL_3l;return HelperClass::Binning2016(mTW, MET, Mll);
}

template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_2016MllBins(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){
 double mTW=readF2.mTL_3l;double MET=readN.met_pt;double Mll=readF2.mllL_3l;return HelperClass::Binning2016Mll(mTW, MET, Mll);
}

template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::UserDef_2016MllBinsv2(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){
