...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v;

   Int_t           HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_isUnprescaled;

   Int_t           HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_Prescale;
   ...
   Int_t           HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v;

   Int_t           HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_isUnprescaled;

   Int_t           HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_Prescale;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_Prescale;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_isUnprescaled;

   Int_t           HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_Prescale;
   ...
   Int_t           HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v;

   Int_t           HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_isUnprescaled;

   Int_t           HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_Prescale;
   ...
   Int_t           GenPart_motherId[31];   //[nGenPart]

   Int_t           GenPart_grandmotherId[31];   //[nGenPart]

   Int_t           GenPart_sourceId[31];   //[nGenPart]

   Float_t         GenPart_charge[31];   //[nGenPart]

   Int_t           GenPart_status[31];   //[nGenPart]

   Int_t           GenPart_isPromptHard[31];   //[nGenPart]

   Int_t           GenPart_pdgId[31];   //[nGenPart]

   Float_t         GenPart_pt[31];   //[nGenPart]

   Float_t         GenPart_eta[31];   //[nGenPart]

   Float_t         GenPart_phi[31];   //[nGenPart]

   Float_t         GenPart_mass[31];   //[nGenPart]

   Int_t           GenPart_motherIndex[31];   //[nGenPart]
   ...
   Int_t           TauOther_charge[6];   //[nTauOther]

   Int_t           TauOther_decayMode[6];   //[nTauOther]

   Int_t           TauOther_idDecayMode[6];   //[nTauOther]

   Int_t           TauOther_idDecayModeNewDMs[6];   //[nTauOther]

   Float_t         TauOther_dxy[6];   //[nTauOther]

   Float_t         TauOther_dz[6];   //[nTauOther]

   Int_t           TauOther_idMVA[6];   //[nTauOther]

   Int_t           TauOther_idMVANewDM[6];   //[nTauOther]

   Int_t           TauOther_idCI3hit[6];   //[nTauOther]

   Int_t           TauOther_idAntiMu[6];   //[nTauOther]

   Int_t           TauOther_idAntiE[6];   //[nTauOther]

   Float_t         TauOther_isoCI3hit[6];   //[nTauOther]

   Int_t           TauOther_mcMatchId[6];   //[nTauOther]

   Int_t           TauOther_pdgId[6];   //[nTauOther]

   Float_t         TauOther_pt[6];   //[nTauOther]

   Float_t         TauOther_eta[6];   //[nTauOther]

   Float_t         TauOther_phi[6];   //[nTauOther]

   Float_t         TauOther_mass[6];   //[nTauOther]

   Int_t           TauOther_idMVAdR03[6];   //[nTauOther]

   Float_t         TauOther_mcUCSXMatchId[6];   //[nTauOther]
   ...
   Float_t         PhoGood_etaSc[3];   //[nPhoGood]

   Int_t           PhoGood_idCutBased[3];   //[nPhoGood]

   Float_t         PhoGood_hOverE[3];   //[nPhoGood]

   Float_t         PhoGood_r9[3];   //[nPhoGood]

   Float_t         PhoGood_sigmaIetaIeta[3];   //[nPhoGood]

   Float_t         PhoGood_chHadIso04[3];   //[nPhoGood]

   Float_t         PhoGood_chHadIso[3];   //[nPhoGood]

   Float_t         PhoGood_phIso[3];   //[nPhoGood]

   Float_t         PhoGood_neuHadIso[3];   //[nPhoGood]

   Float_t         PhoGood_relIso[3];   //[nPhoGood]

   Int_t           PhoGood_mcMatchId[3];   //[nPhoGood]

   Float_t         PhoGood_mcPt[3];   //[nPhoGood]

   Int_t           PhoGood_pdgId[3];   //[nPhoGood]

   Float_t         PhoGood_pt[3];   //[nPhoGood]

   Float_t         PhoGood_eta[3];   //[nPhoGood]

   Float_t         PhoGood_phi[3];   //[nPhoGood]

   Float_t         PhoGood_mass[3];   //[nPhoGood]

   Float_t         PhoGood_genIso04[3];   //[nPhoGood]

   Float_t         PhoGood_genIso03[3];   //[nPhoGood]

   Float_t         PhoGood_chHadIsoRC04[3];   //[nPhoGood]

   Float_t         PhoGood_chHadIsoRC[3];   //[nPhoGood]

   Float_t         PhoGood_drMinParton[3];   //[nPhoGood]


   /////////////
   //Friend trees version-1
   //
   Float_t         LepGood_conePt[6];   //[nLepGood]
   ...
   Int_t           iTV_Mini[20];
   Int_t           LepGood_isLoose_Mini[6];   //[nLepGood]
   Int_t           LepGood_isLooseVeto_Mini[6];   //[nLepGood]
   Int_t           LepGood_isCleaning_Mini[6];   //[nLepGood]
   Int_t           LepGood_isCleaningVeto_Mini[6];   //[nLepGood]
   Int_t           LepGood_isFO_Mini[6];   //[nLepGood]
   Int_t           LepGood_isFOVeto_Mini[6];   //[nLepGood]
   Int_t           LepGood_isTight_Mini[6];   //[nLepGood]
   Int_t           LepGood_isTightVeto_Mini[6];   //[nLepGood]
   Float_t         mZ1_Mini;
   ...
   Int_t           iTauSel_Mini[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_pt[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_eta[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_phi[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_mass[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_reclTauId[4];   //[nTauSel_Mini]
   Float_t         TauSel_Mini_mcMatchId[4];   //[nTauSel_Mini]
   Int_t           TauSel_Mini_pdgId[4];   //[nTauSel_Mini]
   Int_t           nJetSel_Mini;
   Int_t           iJSel_Mini[22];   //[nJetSel_Mini]
   ...
   Int_t           iJSel_Mini_jecUp[22];   //[nJetSel_Mini_jecUp]
   ...
   Int_t           iJSel_Mini_jecDown[22];   //[nJetSel_Mini_jecDown]
   ...
   TBranch        *b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v;   //!

   TBranch        *b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_isUnprescaled;   //!

   TBranch        *b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_Prescale;   //!
   ...
   TBranch        *b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v;   //!

   TBranch        *b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_isUnprescaled;   //!

   TBranch        *b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_Prescale;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_Prescale;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_isUnprescaled;   //!

   TBranch        *b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_Prescale;   //!
   ...
   TBranch        *b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v;   //!

   TBranch        *b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_isUnprescaled;   //!

   TBranch        *b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_Prescale;   //!
...
//    fChain->SetBranchAddress("Flag_badMuonFilter", &Flag_badMuonFilter, &b_Flag_badMuonFilter);
   ...
   fChain->SetBranchAddress("HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v", &HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v, &b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v);

   fChain->SetBranchAddress("HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_isUnprescaled", &HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_isUnprescaled, &b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_isUnprescaled);

   fChain->SetBranchAddress("HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_Prescale", &HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_Prescale, &b_HLT_BIT_HLT_Ele22_eta2p1_WPLoose_GSF_LooseIsoPFtau20_SingleL1_v_Prescale);
   ...
   fChain->SetBranchAddress("HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v", &HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v, &b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_isUnprescaled", &HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_isUnprescaled, &b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_isUnprescaled);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_Prescale", &HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_Prescale, &b_HLT_BIT_HLT_Mu33_Ele33_CaloIdL_GsfTrkIdVL_v_Prescale);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_isUnprescaled);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_Prescale", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_Prescale, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v_Prescale);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_isUnprescaled", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_isUnprescaled, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_isUnprescaled);

   fChain->SetBranchAddress("HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_Prescale", &HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_Prescale, &b_HLT_BIT_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_v_Prescale);
   ...
   fChain->SetBranchAddress("HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v", &HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v, &b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v);

   fChain->SetBranchAddress("HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_isUnprescaled", &HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_isUnprescaled, &b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_isUnprescaled);

   fChain->SetBranchAddress("HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_Prescale", &HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_Prescale, &b_HLT_BIT_HLT_TkMu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v_Prescale);
