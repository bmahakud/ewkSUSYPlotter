...
getVarFromFile('InputDetailsFriendV1.dat')
import os
...
import sys
sys.stdout = open('LoaderFriendV1.C','w')

print 'class LoaderFriendV1{\n '
...
print 'TChain *LoaderFriendV1::Load(string ProcessName="TTJets"){'
