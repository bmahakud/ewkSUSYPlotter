...
getVarFromFile('InputDetailsFriendV2.dat')
import os
...
import sys
sys.stdout = open('LoaderFriendV2.C','w')

print 'class LoaderFriendV2{\n '
...
print 'TChain *LoaderFriendV2::Load(string ProcessName="TTJets"){'
