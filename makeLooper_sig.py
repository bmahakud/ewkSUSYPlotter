...
print 'template <class classInst, class HistogramCreater> class Looper_sig: public HelperClass{'   
...
print 'template <class classInst,class HistogramCreater> void Looper_sig<classInst,HistogramCreater>::Loop(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, HistogramCreater hs,string ProcessName, double lumi)\n'
...
print '            EventWeight=xsecWeights[processInt]*lumi*0.101;'#read.Weight;'
...
print 'template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::Baseline(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){\n'
...
print 'template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::ProcessCuts(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){\n'
...
if len(data.list_Categories)>0:
    num=0
    for icate in data.list_Categories:
       print 'template <class classInst,class HistogramCreater> bool Looper_sig<classInst,HistogramCreater>::%s(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){\n'%(icate)
...
for iname in data.list_VarsFill:
    if "UserDef_" in iname:
        print 'template <class classInst,class HistogramCreater> double Looper_sig<classInst,HistogramCreater>::%s(TChain *trN, TChain *trF1, TChain *trF2, classInst& readN,classInst& readF1,classInst& readF2, string ProcessName,int iEvent){\n'%(iname),
