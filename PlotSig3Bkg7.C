...
void plotS3B7D0( string VarName,TPaveText *txtGen , TH1F *hs1 , string sig_proc1
...
pCMS->AddText("CMS #it{Preliminary}                   130 fb^{-1}, #sqrt{s}= 13 TeV");
TLegend *leg=new TLegend(0.2082943,0.7051483,0.45025753,0.9949564,NULL,"brNDC");
leg->SetTextFont(62);
leg->SetLineColor(1);
leg->SetLineStyle(1);
leg->SetLineWidth(3);
...
TCanvas *c=new TCanvas(Cname,Cname,800,500);
c->cd();
hs1->SetLineWidth(2);
hs1->SetLineColor(1);
hs2->SetLineWidth(2);
